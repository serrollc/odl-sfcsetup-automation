...
outfilename   = exec_dirname + "/config_ServiceNode.py"
...
outfilename   = exec_dirname + "/config_ServiceFunctions.py"
with open(outfilename, 'w') as op_fp:
    op_fp.write("import requests,json\n")
    op_fp.write("from requests.auth import HTTPBasicAuth\n")
    op_fp.write("import rest_utils\n")
...
outfilename   = exec_dirname + "/config_ServiceFunctionsForwarders.py"
with open(outfilename, 'w') as op_fp:
    op_fp.write("import requests,json\n")
    op_fp.write("from requests.auth import HTTPBasicAuth\n")
    op_fp.write("import rest_utils\n")
...
outfilename   = exec_dirname + "/config_ServiceFunctionChains.py"
with open(outfilename, 'w') as op_fp:
    op_fp.write("import requests,json\n")
    op_fp.write("from requests.auth import HTTPBasicAuth\n")
    op_fp.write("import rest_utils\n")
...
outfilename   = exec_dirname + "/config_ServiceFunctionMetadata.py"
with open(outfilename, 'w') as op_fp:
    op_fp.write("import requests,json\n")
    op_fp.write("from requests.auth import HTTPBasicAuth\n")
    op_fp.write("import rest_utils\n")
...
outfilename   = exec_dirname + "/config_ServiceFunctionPaths.py"
with open(outfilename, 'w') as op_fp:
    op_fp.write("import requests,json\n")
    op_fp.write("from requests.auth import HTTPBasicAuth\n")
    op_fp.write("import rest_utils\n")
...
outfilename   = exec_dirname + "/config_RenderedServicePath.py"
with open(outfilename, 'w') as op_fp:
    op_fp.write("import requests,json\n")
    op_fp.write("from requests.auth import HTTPBasicAuth\n")
    op_fp.write("import rest_utils\n")
    ...
    op_fp.write("rest_utils.post(controller_ip, controller_port, controller_user, controller_pass, config_uri, config_data)\n\n")
    op_fp.flush()


#create file for Service Function ACLs configuration
outfilename   = exec_dirname + "/config_ServiceFunctionACLs.py"
with open(outfilename, 'w') as op_fp:
    op_fp.write("import requests,json\n")
    op_fp.write("from requests.auth import HTTPBasicAuth\n")
    op_fp.write("import rest_utils\n")
...
outfilename   = exec_dirname + "/config_ServiceFunctionClassifiers.py"
with open(outfilename, 'w') as op_fp:
    op_fp.write("import requests,json\n")
    op_fp.write("from requests.auth import HTTPBasicAuth\n")
    op_fp.write("import rest_utils\n")
